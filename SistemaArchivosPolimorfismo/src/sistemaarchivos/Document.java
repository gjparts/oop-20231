...
public class Document extends File {
    ...
    public String toString(){
        String str = super.toString();  //recuperar el toString() de la super clase
        str += "\nAuthor: "+( this.author == null ? "undefined" : this.author.nombre  );
        str += "\nModification Date: ";
        ...
        else
        {
            ...
            str += f.format(this.modificationDate.getTime());
        }
        str += "\nwords: "+this.words;
